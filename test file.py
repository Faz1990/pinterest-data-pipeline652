    ...
    while True:
        ...
        with engine.connect() as connection:
            ...
            for row in pin_selected_row:
                ...
                send_data_to_api(pin_result, topic_name, payload)
            ...
            for row in geo_selected_row:
                ...
                send_data_to_api(geo_result, topic_name, payload)
            ...
            for row in user_selected_row:
                ...
                send_data_to_api(user_result, topic_name, payload)
